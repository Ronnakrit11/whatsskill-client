  ...
  return (
    <div>
      <div className={`w-[90%] 800px:w-[80%] m-auto pt-10`}>
        ...
        <br />
        <br />
        <div  data-aos="fade-right"  className="grid grid-cols-2 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] 1500px:grid-cols-4 1500px:gap-[35px] mb-12 border-0">
          {courses &&
